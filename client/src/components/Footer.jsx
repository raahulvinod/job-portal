    ...
    <footer className="text-black dark:text-white px-4 mt-8 py-5 max-w-screen-xl mx-auto md:px-8">
        ...
        <div className="flex-1">
          <div className="max-w-xs">
            ...
            <p className="leading-relaxed mt-2 text-[15px]">
              Discover your next great opportunity.we connect you with the right
              jobs and employers. Start here, and let your career grow with us.
            </p>
          </div>
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="max-w-sm flex items-center border rounded-md p-1">
              ...
              />
              <button className="p-2.5 rounded-md text-white bg-gray-900 outline-none shadow-md focus:shadow-none sm:px-5">
                Subscribe
              </button>
            </div>
          </form>
      ...
      <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
        <div className="mt-4 sm:mt-0">
          &copy; 2024 JobHatch rights reserved.
        </div>
